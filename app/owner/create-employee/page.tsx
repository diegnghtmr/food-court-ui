...
export default function CreateEmployeePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.users.createEmployee({ ...formData, rol: "EMPLEADO" })
      setSuccess(true)
      setFormData({
        nombre: "",
        apellido: "",
    ...
    <RouteGuard allowedRoles={["PROPIETARIO"]}>
      <div className="min-h-screen bg-[#0a0a0a] font-mono">
        ...
        <main className="max-w-2xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-black uppercase text-gray-100 mb-8">CREAR EMPLEADO</h1>
          ...
          <div className="bg-[#121212] border-4 border-violet-600 p-8 shadow-[8px_8px_0px_0px_#22c55e]">
            <p className="text-gray-500 font-bold uppercase text-sm mb-6">
              El empleado será asignado automáticamente a tu restaurante
            </p>
